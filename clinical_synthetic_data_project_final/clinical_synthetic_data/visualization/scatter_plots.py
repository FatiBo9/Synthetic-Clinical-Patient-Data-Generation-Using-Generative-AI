...
KEY_SCATTER_PAIRS: tuple[tuple[str, str, str], ...] = (
    ("fasting_glucose", "hba1c", "Blood glucose vs HbA1c (diabetes)"),
    ("ldl", "hdl", "LDL vs HDL (Dyslipidaemia)"),
    ("sbp", "dbp", "SBP vs DBP (hypertension)"),
    ("bmi", "fasting_glucose", "BMI vs Blood glucose (cardio-metabolic axis)"),
    ("age", "sbp", "Age vs SBP (arterial stiffness)"),
    ("bmi", "triglycerides", "BMI vs Triglycerides (lipids/adiposity)"),
)
...
def plot_scatter_pairs(
    ...
    fig.suptitle(f"scatter plots by class{title_suffix}",
